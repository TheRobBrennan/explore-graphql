...
### Apollo Fullstack GraphQL Tutorial
...
- `apollo-tutorial-server` - The [GraphQL](https://graphql.org)
- `explore-graphql-mongodb` - A [MongoDB](https://www.mongodb.com) server that does not retain data by default
  ...
  - Please refer to `docker-compose.apollo-tutorial.yml` to see how you can map a local path if you want to persist your MongoDB data
